...
export default function PredictionChatPanel({ predictionId }: { predictionId: string }) {
    ...
    return (
        <div className="bg-surface border border-gold-border/50 rounded-2xl overflow-hidden shadow-sm">
            <div className="px-5 py-4 border-b border-gold-border/30 bg-gold-light/20 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <span className="text-xl">💬</span>
                    <h3 className="text-sm font-bold text-heading uppercase">Visa Assistant</h3>
                </div>
                <span className="px-2 py-0.5 bg-primary-100 text-primary-700 text-[10px] font-bold rounded-full uppercase tracking-tighter">
                    Premium Support
                </span>
            </div>
